...
detrended_t2m.to_netcdf("/data/compoundx/anand/PCV/data/detrended_seasonal_t2m_v3.nc")
detrended_tp.to_netcdf("/data/compoundx/anand/PCV/data/detrended_seasonal_tp_v3.nc")
detrended_ssrd.to_netcdf("/data/compoundx/anand/PCV/data/detrended_seasonal_ssrd_v3.nc")
detrended_swvlall.to_netcdf("/data/compoundx/anand/PCV/data/detrended_seasonal_swvlall_v3.nc")
# detrended_sm.to_netcdf("/data/compoundx/anand/PCV/data/detrended_seasonal_smroot.nc")
detrended_lai.to_netcdf("/data/compoundx/anand/PCV/data/detrended_seasonal_lai_v3.nc")
detrended_vpd.to_netcdf("/data/compoundx/anand/PCV/data/detrended_seasonal_vpd_v3.nc")
detrended_sd.to_netcdf("/data/compoundx/anand/PCV/data/detrended_seasonal_sd_v3.nc")
